...
const SubscriptionForPackages = ({ leftIcon, centerText, rightIcon, onPress, tittle, colorBack }) => {
  return (
    <TouchableOpacity style={[styles.cardContainer, {backgroundColor:colorBack}]} onPress={onPress}>
      ...
      <View style={styles.iconContainer}>
        {leftIcon 
          ...
          : <Ionicons name="ios-shield-outline" size={24} color="#000" />} 
      </View>
...
const styles = StyleSheet.create({
  ...
  iconContainer: {
    width: 30,                     // Set fixed width for the left icon
...
export default SubscriptionForPackages;
